...
public class LatencyHistogramPropertyTest {
    ...
    @Property
    void validPercentilesAlwaysReturned(
            @ForAll @DoubleRange(min = -100.0, max = 60_000.0) double latencyMs,
    ...
    @Property
    void heatmapBucketsProperlyTrackAllLatencies(
            @ForAll List<@DoubleRange(min = -1.0, max = 20000.0) Double> latencies) {
