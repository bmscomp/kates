...
public class TestResult {
    ...
    public TestResult withTaskId(String taskId) {
    ...
    public TestResult withTestType(TestType testType) {
        return new TestResult(
                taskId,
                testType,
                status,
    ...
    public TestResult withStatus(TaskStatus status) {
        return new TestResult(
                taskId,
                testType,
                status,
    ...
    public TestResult withRecordsSent(long recordsSent) {
        return new TestResult(
                taskId,
                testType,
                status,
    ...
    public TestResult withThroughputRecordsPerSec(double throughputRecordsPerSec) {
        return new TestResult(
                taskId,
                testType,
                status,
    ...
    public TestResult withThroughputMBPerSec(double throughputMBPerSec) {
        return new TestResult(
                taskId,
                testType,
                status,
    ...
    public TestResult withAvgLatencyMs(double avgLatencyMs) {
        return new TestResult(
                taskId,
                testType,
                status,
    ...
    public TestResult withP50LatencyMs(double p50LatencyMs) {
        return new TestResult(
                taskId,
                testType,
                status,
    ...
    public TestResult withP95LatencyMs(double p95LatencyMs) {
        return new TestResult(
                taskId,
                testType,
                status,
    ...
    public TestResult withP99LatencyMs(double p99LatencyMs) {
        return new TestResult(
                taskId,
                testType,
                status,
    ...
    public TestResult withMaxLatencyMs(double maxLatencyMs) {
        return new TestResult(
                taskId,
                testType,
                status,
    ...
    public TestResult withStartTime(String startTime) {
        return new TestResult(
                taskId,
                testType,
                status,
    ...
    public TestResult withEndTime(String endTime) {
        return new TestResult(
                taskId,
                testType,
                status,
    ...
    public TestResult withError(String error) {
        return new TestResult(
                taskId,
                testType,
                status,
    ...
    public TestResult withPhaseName(String phaseName) {
        return new TestResult(
                taskId,
                testType,
                status,
    ...
    public TestResult withIntegrity(IntegrityResult integrity) {
        return new TestResult(
                taskId,
                testType,
                status,
