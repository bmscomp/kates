        ...
        return switch (type) {
            ...
            case STRESS ->
                new TypeConfig(
                        ...
                        stressPartitions,
                        stressMinInsyncReplicas,
                        stressAcks,
                        stressBatchSize,
                        stressLingerMs,
                        stressCompressionType,
                        stressRecordSize,
                        stressNumRecords,
                        stressThroughput,
                        stressDurationMs,
            ...
            case SPIKE ->
                new TypeConfig(
                        ...
                        spikePartitions,
                        spikeMinInsyncReplicas,
                        spikeAcks,
                        spikeBatchSize,
                        spikeLingerMs,
                        spikeCompressionType,
                        spikeRecordSize,
                        spikeNumRecords,
                        spikeThroughput,
                        spikeDurationMs,
            ...
            case ENDURANCE ->
                new TypeConfig(
                        ...
                        endurancePartitions,
                        enduranceMinInsyncReplicas,
                        enduranceAcks,
                        enduranceBatchSize,
                        enduranceLingerMs,
                        enduranceCompressionType,
                        enduranceRecordSize,
                        enduranceNumRecords,
                        enduranceThroughput,
                        enduranceDurationMs,
            ...
            case VOLUME ->
                new TypeConfig(
                        ...
                        volumePartitions,
                        volumeMinInsyncReplicas,
                        volumeAcks,
                        volumeBatchSize,
                        volumeLingerMs,
                        volumeCompressionType,
                        volumeRecordSize,
                        volumeNumRecords,
                        volumeThroughput,
                        volumeDurationMs,
            ...
            case CAPACITY ->
                new TypeConfig(
                        ...
                        capacityPartitions,
                        capacityMinInsyncReplicas,
                        capacityAcks,
                        capacityBatchSize,
                        capacityLingerMs,
                        capacityCompressionType,
                        capacityRecordSize,
                        capacityNumRecords,
                        capacityThroughput,
                        capacityDurationMs,
            ...
            case ROUND_TRIP ->
                new TypeConfig(
                        ...
                        roundTripPartitions,
                        roundTripMinInsyncReplicas,
                        roundTripAcks,
                        roundTripBatchSize,
                        roundTripLingerMs,
                        roundTripCompressionType,
                        roundTripRecordSize,
                        roundTripNumRecords,
                        roundTripThroughput,
                        roundTripDurationMs,
            ...
            case INTEGRITY, TUNE_REPLICATION, TUNE_ACKS, TUNE_BATCHING, TUNE_COMPRESSION, TUNE_PARTITIONS ->
                new TypeConfig(
                        loadReplicationFactor,
                        loadPartitions,
                        loadMinInsyncReplicas,
