...
public class TuningReport {
    ...
    public List<TuningStep> getSteps() { return steps; }
    public void setSteps(List<TuningStep> steps) { this.steps = steps; }

    public int getBestStepIndex() { return bestStepIndex; }
    public void setBestStepIndex(int bestStepIndex) { this.bestStepIndex = bestStepIndex; }
    ...
    public static class TuningStep {
        ...
        public long getTopicCleanupMs() { return topicCleanupMs; }
        public void setTopicCleanupMs(long topicCleanupMs) { this.topicCleanupMs = topicCleanupMs; }
    }
}
