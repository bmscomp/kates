...
public class TestResultEntity {
    ...
    public void setThroughputRecordsPerSec(double v) {
        this.throughputRecordsPerSec = v;
    }
    ...
    public void setThroughputMBPerSec(double v) {
        this.throughputMBPerSec = v;
    }
    ...
    public void setAvgLatencyMs(double v) {
        this.avgLatencyMs = v;
    }
    ...
    public void setP50LatencyMs(double v) {
        this.p50LatencyMs = v;
    }
    ...
    public void setP95LatencyMs(double v) {
        this.p95LatencyMs = v;
    }
    ...
    public void setP99LatencyMs(double v) {
        this.p99LatencyMs = v;
    }
    ...
    public void setMaxLatencyMs(double v) {
        this.maxLatencyMs = v;
    }
