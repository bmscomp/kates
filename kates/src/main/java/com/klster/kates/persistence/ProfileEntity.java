...
public class ProfileEntity {
    ...
    public Double getRecords() { return records; }
    public void setRecords(Double records) { this.records = records; }
    public Integer getBrokers() { return brokers; }
    public void setBrokers(Integer brokers) { this.brokers = brokers; }
