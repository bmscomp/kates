...
public class BrokerTrendResponse {
    ...
    public List<TrendResponse.DataPoint> getDataPoints() { return dataPoints; }
    public void setDataPoints(List<TrendResponse.DataPoint> dataPoints) { this.dataPoints = dataPoints; }

    public List<TrendResponse.Regression> getRegressions() { return regressions; }
    public void setRegressions(List<TrendResponse.Regression> regressions) { this.regressions = regressions; }
}
