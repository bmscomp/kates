...
public record MetricsSample(
    ...
    public static MetricsSample of(long timestampMs, long records, double recPerSec, double mbPerSec,
                                    double avgLat, double p50, double p95, double p99, double maxLat, long errors) {
