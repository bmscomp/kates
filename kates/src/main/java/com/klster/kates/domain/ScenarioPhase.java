...
public class ScenarioPhase {
    ...
    public enum PhaseType {
        WARMUP, RAMP, STEADY, SPIKE, COOLDOWN
    }
    ...
    public TestSpec getSpec() { return spec; }
    public void setSpec(TestSpec spec) { this.spec = spec; }

    public long getDurationMs() { return durationMs; }
    public void setDurationMs(long durationMs) { this.durationMs = durationMs; }

    public int getTargetThroughput() { return targetThroughput; }
    public void setTargetThroughput(int targetThroughput) { this.targetThroughput = targetThroughput; }

    public int getRampSteps() { return rampSteps; }
    public void setRampSteps(int rampSteps) { this.rampSteps = rampSteps; }
}
