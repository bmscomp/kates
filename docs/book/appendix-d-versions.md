...
| `kafka-cluster` chart | 1.0.2 (app 4.3.1) | `charts/kafka-cluster/Chart.yaml` |
...
| `kates` chart | 0.10.1 (app 1.23.0) | `charts/kates/Chart.yaml` |
...
| `strimzi-operator` chart | 0.3.1 (app 1.2.0) | `charts/strimzi-operator/Chart.yaml` |
