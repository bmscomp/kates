...
| `kates-chaos` chart | 2.1.0 (app 3.28.0) | `charts/kates-chaos/Chart.yaml` |
| `kates-platform` chart | 0.7.0 (app 1.0.0) | `charts/kates-platform/Chart.yaml` |
| `kates` chart | 0.8.0 (app 1.22.0) | `charts/kates/Chart.yaml` |
...
| `mirror-maker2` chart | 0.9.0 (app 4.3.1) | `charts/mirror-maker2/Chart.yaml` |
| `monitoring` chart | 1.3.0 (app 82.4.3) | `charts/monitoring/Chart.yaml` |
