...
monitoring:
  ...
  # grafanaDashboard was REMOVED in 2.2.0: the Kates — Chaos infrastructure
  # board is delivered by charts/monitoring (dashboards.enabled there), and
  # setting any monitoring.grafanaDashboard.* key here is refused.
```
