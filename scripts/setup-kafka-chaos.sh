...
echo "  ./scripts/test-chaos-broker-delete.sh      # Kill a broker pod"
echo "  ./scripts/test-chaos-network-partition.sh  # Isolate a broker from the cluster"
echo "  ./scripts/test-chaos-broker-cpu-hog.sh     # CPU pressure on a broker"
echo "  ./scripts/test-chaos-disk-io-stress.sh     # Disk I/O stress on a broker"
echo "  ./scripts/test-chaos-gameday.sh            # The full GameDay sequence"
echo ""
echo "Or through Helm:"
echo "  make litmus-test                           # Chart test hooks"
echo "  make litmus-gameday                        # GameDay via the chaos chart"
echo ""
