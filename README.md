...
| [`kates-chaos`](charts/kates-chaos/) | 2.1.0 | 3.28.0 | Kates Chaos Engineering — wraps the LitmusChaos execution plane (operator, exporter, CRDs) with Kafka-specific RBAC, experiment/engine templating, and monitoring |
...
| [`kates`](charts/kates/) | 0.8.0 | 1.22.0 | Kates — Kafka Advanced Testing & Engineering Suite |
...
| [`mirror-maker2`](charts/mirror-maker2/) | 0.9.0 | 4.3.1 | Strimzi KafkaMirrorMaker2 — cross-cluster replication, DR, and cross-version migration (2.x/3.x → 4.x) |
| [`monitoring`](charts/monitoring/) | 1.3.0 | 82.4.3 | Kates Monitoring — wraps kube-prometheus-stack with Kates-specific dashboards and configuration |
