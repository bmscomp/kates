...
| [`kafka-cluster`](charts/kafka-cluster/) | 1.0.2 | 4.3.1 | A Strimzi Kafka cluster in KRaft mode — node pools, topics, users, rebalancing, tiered storage, network policy and observability |
...
| [`kates`](charts/kates/) | 0.10.0 | 1.23.0 | Kates — Kafka Advanced Testing & Engineering Suite |
