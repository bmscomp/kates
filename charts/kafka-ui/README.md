...
flowchart LR
    ...
    subgraph KAFKA_NS["Kubernetes · kafka namespace"]
        ...
        CONNECT["🔴 Kafka Connect<br/>REST API :8083<br/>Debezium 3.6.2 CDC<br/>PostgreSQL · MySQL · MongoDB<br/>SQL Server<br/>JDBC Sink · S3 Sink/Source<br/>Scripting SMT"]

        CONNECT -- "CDC events /<br/>Sink reads" --> BROKERS
        APICURIO -- "Schema storage<br/>in Kafka topics" --> BROKERS

        CONNECT --- DB[("🗄️ Databases<br/>PostgreSQL · MySQL<br/>SQL Server · MongoDB")]
